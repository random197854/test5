...
window.onload = function() {
	...
	for(let i = 0; i < permPreloadUI.length; i++){
		permPreloadUI[i] = "./data/ui/" + permPreloadUI[i] + ".webp";
	}
	...
	main.elements.contents.addEventListener("transitionend", function(){
		if(parseInt(main.elements.contents.style.height) > 720){
			main.elements.contents.style.backgroundImage = "url('./data/ui/pc_game_frm_big.webp')";
		}else{
			main.elements.contents.style.backgroundImage = "url('./data/ui/pc_game_frm.webp')";
		}
	}, true);
